...
namespace RacingGame
{
    public partial class Form1 : Form
    {
        ...
        private Point pos; //где нажали мышкой
        private bool dragging; //передвигаем или нет
        ...
        public Form1()
        {
            ...
            bg1.MouseDown += MouseClickDown; //нажали мышкой
            bg1.MouseUp += MouseClickUp; //отпустили мышкой
            bg1.MouseMove += MouseClickMove; //передвигаем во время нажатия
        ...
        private void MouseClickMove(object sender, MouseEventArgs e)
        {
            if (dragging)
            {
                //Где сейчас мышь, когда мы двигаем
                Point currPoint = PointToScreen(new Point(e.X,e.Y)); //координаты преобразуем к координатам на мониторе
        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            if (lose)
            {
                return; //Игрок нажимает кнопку влево-вправо, заходит в функцию и lose - true
                //Поэтому не будет двигаться
            }
